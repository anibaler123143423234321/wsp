                        ...
                        <div className="flex-1 min-w-0 flex flex-col overflow-visible relative" style={{ gap: '4px', overflow: 'visible', position: 'relative' }}>
                          ...
                          <div className="flex items-center justify-between gap-2">
                            <div className="flex-1 min-w-0 flex items-center gap-1">
                              {conv.lastMessage ? (
                                <>
                                  {conv.lastMessageFrom && <span className="font-semibold flex-shrink-0" style={{ fontSize: '11px', lineHeight: '14px', fontFamily: 'Inter, sans-serif', fontWeight: 600, color: '#00a884' }}>{conv.lastMessageFrom.split(' ')[0]}:</span>}
